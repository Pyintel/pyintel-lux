...
#define LUX_FLAG_TRANSPORT_NRF_RADIO (1 << LUX_TRANSPORT_NRF_RADIO)

/* ── Transport Interface Definition ──────────────────────────────── */
typedef struct lux_transport {
    lux_transport_id_t id;
    const char        *name;           /* "Serial", "ESP-NOW", "WiFi-UDP", "BLE", "nRF-Radio" */
...
/* ESP32 Family */
  ...
  #define LUX_HAS_NRF_RADIO  0

/* Nordic nRF51 & nRF52 Family (Adafruit CLUE, BBC micro:bit, Feather nRF52840) */
#elif defined(NRF51) || defined(NRF52_SERIES) || defined(ARDUINO_ARCH_NRF5) || defined(ARDUINO_ARCH_NRF52) || defined(ARDUINO_NRF52_ADAFRUIT)
  #define LUX_HAS_SERIAL     1
  #define LUX_HAS_ESPNOW     0
  #define LUX_HAS_WIFI_UDP   0
  #define LUX_HAS_BLE        0
  #define LUX_HAS_NRF_RADIO  1
